...
for activo in activos:
    ...
    df_1h = analizar_setup_1h(df_1h, df_1d, margen_zona=0.05)
    
    # 3. Simular
    df_resultados = simular_mtf(df_1h, df_15m, ratio_riesgo_beneficio=2.0, margen_sl=0.01)
